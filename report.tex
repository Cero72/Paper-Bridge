...
\vspace{0.3cm}
\begin{itemize}
    \item \textbf{Mechanical Engineering + Machine Learning}: \href{https://github.com/Cero72/Paper-Bridge/blob/main/sample_outputs/mech_ML.png}{Link}
    \item \textbf{Neuroscience + Reinforcement Learning}: \href{https://github.com/Cero72/Paper-Bridge/blob/main/sample_outputs/Neuro_RL.png}{Link}
    \item \textbf{Protein Folding + Machine Learning}: \href{https://github.com/Cero72/Paper-Bridge/blob/main/sample_outputs/Protein_ML.png}{Link}
\end{itemize}
\vspace{0.3cm}
